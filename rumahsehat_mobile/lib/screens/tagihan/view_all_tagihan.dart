                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            ...
                                            Text(listTagihan![index].status.toString(), style: Theme.of(context).textTheme.caption),
                                            Text(listTagihan![index].tanggalTerbuat.toString(), style: Theme.of(context).textTheme.caption),
